...
function appmiddlewareinvoker(inputParam, isBlocking, indicator, datasetID) {
    ...
    inputParam["platformver"] = "6.5.GA_v201603111615";
...
function callAppMenu() {
    var appMenu = [
        ["Home", "Home", "appmenuhome.png", null,
        {
            "showAsFlag": constants.MENUITEM_SHOW_AS_ACTION_NEVER
        }],
        ["Cart", "Cart", "appmenucart.png", null,
        {
            "showAsFlag": constants.MENUITEM_SHOW_AS_ACTION_NEVER
        }],
        ["Stores", "Stores", "appmenustore.png", null,
        {
            "showAsFlag": constants.MENUITEM_SHOW_AS_ACTION_NEVER
        }]
    ];
    kony.application.createAppMenu("CertificationAppMenu", appMenu, null, null);
    kony.application.setCurrentAppMenu("CertificationAppMenu");
}