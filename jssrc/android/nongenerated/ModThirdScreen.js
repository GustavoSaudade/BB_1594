...
function showDetail(productData) {
    ...
    FormProductDetail.LblPriceProductDetail.text = productData['onSale'] == 'true' ? 'On Sale! ' + productData['formatedSalePrice']['text'] : productData['formatedSalePrice']['text'];
...
function setImagesToWidget(images) {
    ...
    var imageAttributes = ['largeFrontImage', 'topViewImage', 'leftViewImage', 'rightViewImage', 'backViewImage', 'remoteControlImage', 'energyGuideImage', 'alternateViewsImage', 'angleImage', 'accessoriesImage'];
