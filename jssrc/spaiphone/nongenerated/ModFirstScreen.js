...
function processCategories(categoriesResponse) {
    if (categoriesResponse != null && categoriesResponse.opstatus == 0) {
        kony.print("@@@@@@@@@@@@@@@@@@@@@@@@@> RESPONSE ARE RECEIVED FROM SERVICE: " + JSON.stringify(categoriesResponse));
...
function clickCategory() {
    ...
    kony.print("@@@@@@@@@@@@@@@@@@@@@@@@@> CATEGORY ARE CLICKED!!!" + " selectedData = " + JSON.stringify(selectedData));
